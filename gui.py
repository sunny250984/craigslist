...
class Main(QMainWindow):
    ...
    def make_ui(self, app):
        ...
        # chrome_action = QAction('&Open Chrome', self)
        # chrome_action.setToolTip('Opens Google Chrome')
        # chrome_action.triggered.connect(self.open_chrome)
        # settings_menu.addAction(chrome_action)
    ...
    def about_dialog(self):
        ...
        about.setText(
            '<h1 align=center>CL-Checker 1.5</h1>'
            ...
            '<p align=center><small>Written in 2022 by <a href="freelancer.com/u/zcollins">Zach C.<a/></small></p>'
        )
